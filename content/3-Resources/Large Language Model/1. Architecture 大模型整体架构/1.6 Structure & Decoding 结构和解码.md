...
![1.6 Structure & Decoding 结构和解码-image-48.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644012778_1.6_Structure___Decoding_结构和解码-image-48.png)
![1.6 Structure & Decoding 结构和解码-image-47.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644005665_1.6_Structure___Decoding_结构和解码-image-47.png)

## Dense Model 稠密模型

**Dense 模型** 是相对 **MoE（混合专家来说的）**，一般常见的模型大部分都是稠密参数模型，**每次推理都会激活全部的参数**

![1.6 Structure & Decoding 结构和解码-image-46.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644008186_1.6_Structure___Decoding_结构和解码-image-46.png)

**Casual Decoder/Decoder-only**

![1.6 Structure & Decoding 结构和解码-image-44.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644001321_1.6_Structure___Decoding_结构和解码-image-44.png)

          **Prefix LM**
![1.6 Structure & Decoding 结构和解码-image-45.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644005362_1.6_Structure___Decoding_结构和解码-image-45.png)
...
![1.6 Structure & Decoding 结构和解码-image-42.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643998248_1.6_Structure___Decoding_结构和解码-image-42.png)
...
![1.6 Structure & Decoding 结构和解码-image-43.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644001201_1.6_Structure___Decoding_结构和解码-image-43.png)
![1.6 Structure & Decoding 结构和解码-image-40.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643998554_1.6_Structure___Decoding_结构和解码-image-40.png)

**MoE模型路由示意图**

> 需要注意的是，“专家”并不专注于特定领域，如“心理学”或“生物学”。专家在学习过程中最多只能掌握关于单词层面的句法信息，更具体地说，专家的专长是在特定上下文中处理特定token
![1.6 Structure & Decoding 结构和解码-image-36.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643997111_1.6_Structure___Decoding_结构和解码-image-36.png)
> **密集层（Dense层）**
> * **FFN** 使模型能够利用由注意力机制创建的上下文信息，进一步学习捕捉数据中更复杂的关系
> * 然而，FFN的规模会迅速增长。**为了学习这些复杂关系，它通常会扩展接收到的输入（中间层维度扩展）**
> * 密集模型的 **输入激活了所有参数**
![1.6 Structure & Decoding 结构和解码-image-39.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643999637_1.6_Structure___Decoding_结构和解码-image-39.png)
![1.6 Structure & Decoding 结构和解码-image-49.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644011343_1.6_Structure___Decoding_结构和解码-image-49.png)
> **稀疏层（Sparse层）**
> * 稀疏模型 **仅激活其总参数的一部分**，与混合专家密切相关
> * 可以将密集模型分割成片段（即专家），重新训练，在给定时间仅激活一部分专家
> * 其基本思想是 **每个专家在训练过程中学习不同的信息。然后，在运行推理时，仅使用与特定任务最相关的专家**
![1.6 Structure & Decoding 结构和解码-image-37.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643993402_1.6_Structure___Decoding_结构和解码-image-37.png)
![1.6 Structure & Decoding 结构和解码-image-35.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643995526_1.6_Structure___Decoding_结构和解码-image-35.png)
...
![1.6 Structure & Decoding 结构和解码-image-41.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644005497_1.6_Structure___Decoding_结构和解码-image-41.png)

**Encoder专家专业化示意图**

![1.6 Structure & Decoding 结构和解码-image-34.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643986823_1.6_Structure___Decoding_结构和解码-image-34.png)
...
![1.6 Structure & Decoding 结构和解码-image-38.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643993391_1.6_Structure___Decoding_结构和解码-image-38.png)
...
![1.6 Structure & Decoding 结构和解码-image-33.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643994099_1.6_Structure___Decoding_结构和解码-image-33.png)

**完整的FFN专家**

![1.6 Structure & Decoding 结构和解码-image-31.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643988995_1.6_Structure___Decoding_结构和解码-image-31.png)

**每个token的路径不尽相同**

![1.6 Structure & Decoding 结构和解码-image-32.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643985704_1.6_Structure___Decoding_结构和解码-image-32.png)

**生成token前经过多个专家**

![1.6 Structure & Decoding 结构和解码-image-29.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643987860_1.6_Structure___Decoding_结构和解码-image-29.png)
...
![1.6 Structure & Decoding 结构和解码-image-27.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643980742_1.6_Structure___Decoding_结构和解码-image-27.png)

**MoE Layer**

![1.6 Structure & Decoding 结构和解码-image-30.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643980821_1.6_Structure___Decoding_结构和解码-image-30.png)
...
![1.6 Structure & Decoding 结构和解码-image-24.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643974816_1.6_Structure___Decoding_结构和解码-image-24.png)

### 路由函数的种类

根据对每个输入的处理方法，Router（Gate）可分为三种类型：**稀疏式、密集式和 soft 式**。其中 **前两种上面讲到了，soft 式则包括完全可微方法，包括输入 token 融合和专家融合**

![1.6 Structure & Decoding 结构和解码-image-28.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643986454_1.6_Structure___Decoding_结构和解码-image-28.png)
...
![1.6 Structure & Decoding 结构和解码-image-25.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643973774_1.6_Structure___Decoding_结构和解码-image-25.png)
![1.6 Structure & Decoding 结构和解码-image-20.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643972122_1.6_Structure___Decoding_结构和解码-image-20.png)
![1.6 Structure & Decoding 结构和解码-image-22.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643971492_1.6_Structure___Decoding_结构和解码-image-22.png)
![1.6 Structure & Decoding 结构和解码-image-26.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643979055_1.6_Structure___Decoding_结构和解码-image-26.png)
...
![1.6 Structure & Decoding 结构和解码-image-23.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643980842_1.6_Structure___Decoding_结构和解码-image-23.png)
...
![1.6 Structure & Decoding 结构和解码-image-21.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643974001_1.6_Structure___Decoding_结构和解码-image-21.png)
![1.6 Structure & Decoding 结构和解码-image-18.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643970228_1.6_Structure___Decoding_结构和解码-image-18.png)
![1.6 Structure & Decoding 结构和解码-image-16.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643960455_1.6_Structure___Decoding_结构和解码-image-16.png)

### Token Choice

KeepTopK 策略将每个 token 路由到少数选定的专家。这种方法称为 **Token Choice**，它允许将给定的词元发送给一个专家（top-1路由），或者发送给多个专家（top-k路由）。一个主要的好处是它允许权衡和整合专家各自的贡献

![1.6 Structure & Decoding 结构和解码-image-19.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643972502_1.6_Structure___Decoding_结构和解码-image-19.png)
![1.6 Structure & Decoding 结构和解码-image-17.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643966325_1.6_Structure___Decoding_结构和解码-image-17.png)
...
![1.6 Structure & Decoding 结构和解码-image-14.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643965839_1.6_Structure___Decoding_结构和解码-image-14.png)
![1.6 Structure & Decoding 结构和解码-image-15.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643960004_1.6_Structure___Decoding_结构和解码-image-15.png)
![1.6 Structure & Decoding 结构和解码-image-10.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643952822_1.6_Structure___Decoding_结构和解码-image-10.png)
![1.6 Structure & Decoding 结构和解码-image-11.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643959107_1.6_Structure___Decoding_结构和解码-image-11.png)
...
![1.6 Structure & Decoding 结构和解码-image-12.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643962290_1.6_Structure___Decoding_结构和解码-image-12.png)
![1.6 Structure & Decoding 结构和解码-image-9.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644014949_1.6_Structure___Decoding_结构和解码-image-9.png)
...
![1.6 Structure & Decoding 结构和解码-image-8.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644010939_1.6_Structure___Decoding_结构和解码-image-8.png)
![1.6 Structure & Decoding 结构和解码-image-5.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644011625_1.6_Structure___Decoding_结构和解码-image-5.png)

**容量因子示意图**

![1.6 Structure & Decoding 结构和解码-image-7.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644012609_1.6_Structure___Decoding_结构和解码-image-7.png)
...
![1.6 Structure & Decoding 结构和解码-image-4.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644002403_1.6_Structure___Decoding_结构和解码-image-4.png)
![1.6 Structure & Decoding 结构和解码-image-13.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643964328_1.6_Structure___Decoding_结构和解码-image-13.png)
![1.6 Structure & Decoding 结构和解码-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643958964_1.6_Structure___Decoding_结构和解码-image-1.png)
...
![1.6 Structure & Decoding 结构和解码-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644016738_1.6_Structure___Decoding_结构和解码-image.png)
...
![1.6 Structure & Decoding 结构和解码-image-6.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644011521_1.6_Structure___Decoding_结构和解码-image-6.png)
...
![1.6 Structure & Decoding 结构和解码-image-3.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643989200_1.6_Structure___Decoding_结构和解码-image-3.png)
...
![1.6 Structure & Decoding 结构和解码-image-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643973236_1.6_Structure___Decoding_结构和解码-image-2.png)
...
![1.6 Structure & Decoding 结构和解码-diagram.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643959675_1.6_Structure___Decoding_结构和解码-diagram.png)
