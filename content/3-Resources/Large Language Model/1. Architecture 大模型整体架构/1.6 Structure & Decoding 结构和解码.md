...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-48.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-47.png`

## Dense Model 稠密模型

**Dense 模型** 是相对 **MoE（混合专家来说的）**，一般常见的模型大部分都是稠密参数模型，**每次推理都会激活全部的参数**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-46.png`

**Casual Decoder/Decoder-only**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-44.png`

          **Prefix LM**
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-45.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-42.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-43.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-40.png`

**MoE模型路由示意图**

> 需要注意的是，“专家”并不专注于特定领域，如“心理学”或“生物学”。专家在学习过程中最多只能掌握关于单词层面的句法信息，更具体地说，专家的专长是在特定上下文中处理特定token
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-36.png`
> **密集层（Dense层）**
> * **FFN** 使模型能够利用由注意力机制创建的上下文信息，进一步学习捕捉数据中更复杂的关系
> * 然而，FFN的规模会迅速增长。**为了学习这些复杂关系，它通常会扩展接收到的输入（中间层维度扩展）**
> * 密集模型的 **输入激活了所有参数**
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-39.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-49.png`
> **稀疏层（Sparse层）**
> * 稀疏模型 **仅激活其总参数的一部分**，与混合专家密切相关
> * 可以将密集模型分割成片段（即专家），重新训练，在给定时间仅激活一部分专家
> * 其基本思想是 **每个专家在训练过程中学习不同的信息。然后，在运行推理时，仅使用与特定任务最相关的专家**
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-37.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-35.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-41.png`

**Encoder专家专业化示意图**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-34.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-38.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-33.png`

**完整的FFN专家**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-31.png`

**每个token的路径不尽相同**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-32.png`

**生成token前经过多个专家**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-29.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-27.png`

**MoE Layer**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-30.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-24.png`

### 路由函数的种类

根据对每个输入的处理方法，Router（Gate）可分为三种类型：**稀疏式、密集式和 soft 式**。其中 **前两种上面讲到了，soft 式则包括完全可微方法，包括输入 token 融合和专家融合**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-28.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-25.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-20.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-22.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-26.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-23.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-21.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-18.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-16.png`

### Token Choice

KeepTopK 策略将每个 token 路由到少数选定的专家。这种方法称为 **Token Choice**，它允许将给定的词元发送给一个专家（top-1路由），或者发送给多个专家（top-k路由）。一个主要的好处是它允许权衡和整合专家各自的贡献

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-19.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-17.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-14.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-15.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-10.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-11.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-12.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-9.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-8.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-5.png`

**容量因子示意图**

> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-7.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-4.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-13.png`
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-1.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-6.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-3.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-image-2.png`
...
> [!missing-image] 缺失图片：`images/1.6 Structure & Decoding 结构和解码-diagram.png`
