...
![1.3 Attention 注意力-image-31.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643907947_1.3_Attention_注意力-image-31.png)
![1.3 Attention 注意力-image-30.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643902623_1.3_Attention_注意力-image-30.png)
...
![1.3 Attention 注意力-image-28.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643899933_1.3_Attention_注意力-image-28.png)
![1.3 Attention 注意力-image-27.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643899358_1.3_Attention_注意力-image-27.png)
...
Self Attention的时间复杂度是 $O(N^2)$ 的，它要对序列中的 **任意两个向量都要计算相关度**，得到一个 $N^2$ 大小的相关度矩阵，图示如下：

![1.3 Attention 注意力-image-26.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643898474_1.3_Attention_注意力-image-26.png)
...
![1.3 Attention 注意力-image-25.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643895079_1.3_Attention_注意力-image-25.png)
...
![1.3 Attention 注意力-image-22.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643887967_1.3_Attention_注意力-image-22.png)
...
![1.3 Attention 注意力-image-23.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643897330_1.3_Attention_注意力-image-23.png)

* **不使用KV Cache的生成流程**

如果模型的输出目标是“唱跳篮球”，我们看生成第一个字“唱”时，Attention的计算流程：

![1.3 Attention 注意力-diagram.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643871035_1.3_Attention_注意力-diagram.png)

当模型生成第二个“跳”字时，input="\<s>唱", Attention的计算如下：

![1.3 Attention 注意力-diagram-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643872925_1.3_Attention_注意力-diagram-1.png)
...
![1.3 Attention 注意力-diagram-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643873025_1.3_Attention_注意力-diagram-2.png)
...
> 1. **共用 KV cache：MQA，GQA 见1.3.5章 [[1.3 Attention 注意力]]**
> 2. **窗口优化：**
...
> * 对每个chunk的结果进行reduce
![1.3 Attention 注意力-image-21.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643892212_1.3_Attention_注意力-image-21.png)
...
![1.3 Attention 注意力-image-32.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643912701_1.3_Attention_注意力-image-32.png)
...
![1.3 Attention 注意力-image-20.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643895296_1.3_Attention_注意力-image-20.png)

* **手撕MHA代码：**

**这部分代码在代码子文档，记得在在文档首页去点击链接下载**

![1.3 Attention 注意力-image-19.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643891853_1.3_Attention_注意力-image-19.png)
...
* **带KVCache版本的手撕：**
![1.3 Attention 注意力-image-17.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643882608_1.3_Attention_注意力-image-17.png)
...
![1.3 Attention 注意力-image-14.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643884222_1.3_Attention_注意力-image-14.png)
![1.3 Attention 注意力-image-29.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643906738_1.3_Attention_注意力-image-29.png)
...
* **解耦的RoPE：RoPE与低秩KV Cache并不兼容**，前面的压缩的时候可以将 $W^{UK}$ 融进 $W^{Q}$ 但是在加上RoPE的情况下不行，回忆一下RoPE： $(R_{m}q)^T (R_{n}k) = q^T R_{m}^T R_{n} k = q^T R_{m - n} k$，query和key中间有一个跟位置相关的矩阵，那么 $W^{UK}R_{m-n}W^{Q}$ 就不能合并成一个固定的投影矩阵了。
  ...
  > 补充：MLA 把 Q/K 拆成 content 分支和 RoPE 分支。content 分支走低秩 KV 压缩，方便把 W^{UK}、W^{UV} 吸收到 query/output 相关投影里
  >
  > 然后 RoPE 分支单独生成 q^R 和共享的 k^R，只在这部分施加 RoPE。最后把 \[q^C;q^R] 和 \[k^C;k^R] 拼接后一起做 attention，本质上就是 content score 加上 RoPE score，保留位置编码，又不破坏低秩 KV cache 的压缩结构
  $$
...
![1.3 Attention 注意力-image-16.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643879963_1.3_Attention_注意力-image-16.png)
...
推理阶段的时候Q、K的Head Size变成了dc+dr，V的Head Size 则变成了dc，按照原论文的设置，这是dk、dv的4倍。所以实际上MLA在推理阶段做的这个转换，虽然能有效减少KV Cache，但其推理的计算量是增加的。那为什么还能提高推理效率呢？我们可以将 **LLM的推理分两部分：第一个Token的生成（Prefill）和后续每个Token的生成（Generation）**，**Prefill阶段涉及到对输入所有Token的并行计算，然后把对应的KV Cache存下来，这部分对于计算、带宽和显存都是瓶颈，MLA虽然增大了计算量，但KV Cache的减少也降低了显存和带宽的压力，大家半斤八两**；但是 **Generation阶段由于每步只计算一个Token，实际上它更多的是带宽瓶颈和显存瓶颈，因此MLA的引入理论上能明显提高Generation的速度**

* **MLA训练和推理示意图：**
![1.3 Attention 注意力-image-13.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643885641_1.3_Attention_注意力-image-13.png)
![1.3 Attention 注意力-image-12.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643885747_1.3_Attention_注意力-image-12.png)
...
![1.3 Attention 注意力-image-24.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643899424_1.3_Attention_注意力-image-24.png)
...
![1.3 Attention 注意力-image-18.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643890675_1.3_Attention_注意力-image-18.png)
...
![1.3 Attention 注意力-image-11.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643880359_1.3_Attention_注意力-image-11.png)
![1.3 Attention 注意力-image-10.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643874591_1.3_Attention_注意力-image-10.png)
...
> $a⊙b=[1×4, 2×5, 3×6]=[4,10,18],$ $a=[1,2,3],$ $b=[4,5,6]$，gate 每一维一般在 \[0,1] 之间，表示信息保留多少 **（<u>感叹一下nano banana pro太强了</u>）**
![1.3 Attention 注意力-image-9.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643920531_1.3_Attention_注意力-image-9.png)

### 常见门控机制：LSTM

![1.3 Attention 注意力-image-15.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643884232_1.3_Attention_注意力-image-15.png)
...
![1.3 Attention 注意力-image-8.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643914907_1.3_Attention_注意力-image-8.png)
...
这部分在[[1.4 FFN & Add & LN 前馈层、残差、层归一化]]有讲解
...
![1.3 Attention 注意力-image-3.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643904771_1.3_Attention_注意力-image-3.png)
...
![1.3 Attention 注意力-image-6.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643907292_1.3_Attention_注意力-image-6.png)
...
![1.3 Attention 注意力-image-4.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643913220_1.3_Attention_注意力-image-4.png)
![1.3 Attention 注意力-image-7.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643913610_1.3_Attention_注意力-image-7.png)

**<u>G1 位置的效果最好</u>**

![1.3 Attention 注意力-image-5.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643911393_1.3_Attention_注意力-image-5.png)

* **在 15B MoE 模型上，同样的训练数据、配置，只改 gate 位置。如上图左所示，<u>SDPA 输出之后，output 转置之前的 G1位置，对比基线其 MMLU 分数增加最多，同时多领域困惑度 PPL最低</u>**
...
**<u>稀疏、query-dependent 的 gating 可以干掉 attention sink</u>**

* **attention sink：LLM 会对输入序列的第一个 token（或者某些特殊锚点 token）给出莫名巨高的注意力权重，和语义没关系**
![1.3 Attention 注意力-image-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643893507_1.3_Attention_注意力-image-2.png)
...
![1.3 Attention 注意力-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643878506_1.3_Attention_注意力-image-1.png)

* **真正有效的是 输入相关 + head-specific + 稀疏的 gating，它在 SDPA 输出上给出强烈的soft masking，把与当前 query 无关的 context 压掉，attention sink 自然就少了。**
* **这与[<u>这篇论文</u>](https://arxiv.org/abs/2410.10781)的 attention sink 是 softmax 下的一种 key bias 的观察一致：改变 softmax 本身能消灭 sink（比如sigmoid attention），但 Qwen 这里说明在 softmax 不动的前提下，通过 SDPA 输出的稀疏门控，也能有效的把 bias 压回去**

**<u>长上下文扩展&训练稳定性</u>**

![1.3 Attention 注意力-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643917810_1.3_Attention_注意力-image.png)
...
# 1.3.9 NSA(Native Sparse Attention)

见[[DeepSeek NSA 解读：三叉戟稀疏注意力]]

# 1.3.10 DSA(DeepSeek Sparse Attention)
