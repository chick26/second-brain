...
![](<../images/1.3 Attention 注意力-image-31.png>)
![](<../images/1.3 Attention 注意力-image-30.png>)
...
![](<../images/1.3 Attention 注意力-image-28.png>)
![](<../images/1.3 Attention 注意力-image-27.png>)
...
![](<../images/1.3 Attention 注意力-image-26.png>)
...
![](<../images/1.3 Attention 注意力-image-25.png>)
...
![](<../images/1.3 Attention 注意力-image-22.png>)
...
![](<../images/1.3 Attention 注意力-image-23.png>)

* **不使用KV Cache的生成流程**

如果模型的输出目标是“唱跳篮球”，我们看生成第一个字“唱”时，Attention的计算流程：

![](<../images/1.3 Attention 注意力-diagram.png>)

当模型生成第二个“跳”字时，input="\<s>唱", Attention的计算如下：

![](<../images/1.3 Attention 注意力-diagram-1.png>)
...
![](<../images/1.3 Attention 注意力-diagram-2.png>)
...
> * 对每个chunk的结果进行reduce
![](<../images/1.3 Attention 注意力-image-21.png>)
...
![](<../images/1.3 Attention 注意力-image-32.png>)
...
![](<../images/1.3 Attention 注意力-image-20.png>)

* **手撕MHA代码：**

**这部分代码在代码子文档，记得在在文档首页去点击链接下载**

![](<../images/1.3 Attention 注意力-image-19.png>)
...
* **带KVCache版本的手撕：**
![](<../images/1.3 Attention 注意力-image-17.png>)
...
![](<../images/1.3 Attention 注意力-image-14.png>)
![](<../images/1.3 Attention 注意力-image-29.png>)
...
![](<../images/1.3 Attention 注意力-image-16.png>)
...
* **MLA训练和推理示意图：**
![](<../images/1.3 Attention 注意力-image-13.png>)
![](<../images/1.3 Attention 注意力-image-12.png>)
...
![](<../images/1.3 Attention 注意力-image-24.png>)
...
![](<../images/1.3 Attention 注意力-image-18.png>)
...
![](<../images/1.3 Attention 注意力-image-11.png>)
![](<../images/1.3 Attention 注意力-image-10.png>)
...
![](<../images/1.3 Attention 注意力-image-9.png>)

### 常见门控机制：LSTM

![](<../images/1.3 Attention 注意力-image-15.png>)
...
![](<../images/1.3 Attention 注意力-image-8.png>)
...
![](<../images/1.3 Attention 注意力-image-3.png>)
...
![](<../images/1.3 Attention 注意力-image-6.png>)
...
![](<../images/1.3 Attention 注意力-image-4.png>)
![](<../images/1.3 Attention 注意力-image-7.png>)

**<u>G1 位置的效果最好</u>**

![](<../images/1.3 Attention 注意力-image-5.png>)
...
![](<../images/1.3 Attention 注意力-image-2.png>)
...
![](<../images/1.3 Attention 注意力-image-1.png>)
...
![](<../images/1.3 Attention 注意力-image.png>)
