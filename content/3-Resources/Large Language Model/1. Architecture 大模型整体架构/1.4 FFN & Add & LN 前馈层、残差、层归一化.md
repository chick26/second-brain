...
tags:
  - topic/ai
  - topic/llm
topic: "1.4 FFN & Add & LN 前馈层、残差、层归一化"
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-15.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643928796_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-15.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-14.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643927186_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-14.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-17.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643926718_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-17.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-16.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643923956_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-16.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-8.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643940171_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-8.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-12.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643920929_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-12.png)
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-13.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643926535_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-13.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-11.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643915333_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-11.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-7.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643935785_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-7.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-5.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643929361_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-5.png)

**一般激活函数**

![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-10.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643914946_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-10.png)
...
> $$f(x) = \frac{1}{1+e^{-x}}\\
> f'(x) = f(x)f(1-x)$$
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-9.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643942480_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-9.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-4.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643933721_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-4.png)
...
> $f(x) = \max(0,x)$
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-3.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643929547_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-3.png)
...
> * **有些近似线性，导致在复杂分类中效果不好**
> $f(x)=\max(\alpha x, x)$
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-6.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643938488_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-6.png)
...
> x, & \text{for } x > 0
> \end{cases}$$
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643934074_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-2.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643919988_1.4_FFN___Add___LN_前馈层、残差、层归一化-image-1.png)
...
![1.4 FFN & Add & LN 前馈层、残差、层归一化-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782643937679_1.4_FFN___Add___LN_前馈层、残差、层归一化-image.png)
