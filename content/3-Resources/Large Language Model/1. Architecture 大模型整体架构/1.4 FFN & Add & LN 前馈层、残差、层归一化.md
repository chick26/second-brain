...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-15.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-14.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-17.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-16.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-8.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-12.png>)
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-13.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-11.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-7.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-5.png>)

**一般激活函数**

![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-10.png>)
...
> $$f(x) = \frac{1}{1+e^{-x}}\\
> f'(x) = f(x)f(1-x)$$
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-9.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-4.png>)
...
> $f(x) = \max(0,x)$
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-3.png>)
...
> * **有些近似线性，导致在复杂分类中效果不好**
> $f(x)=\max(\alpha x, x)$
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-6.png>)
...
> x, & \text{for } x > 0
> \end{cases}$$
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-2.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image-1.png>)
...
![](<../images/1.4 FFN & Add & LN 前馈层、残差、层归一化-image.png>)
