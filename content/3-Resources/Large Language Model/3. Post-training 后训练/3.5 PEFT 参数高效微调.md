...
![3.5 PEFT 参数高效微调-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644349757_3.5_PEFT_参数高效微调-image.png)
...
![3.5 PEFT 参数高效微调-image-19.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644341423_3.5_PEFT_参数高效微调-image-19.png)
![3.5 PEFT 参数高效微调-image-15.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644335030_3.5_PEFT_参数高效微调-image-15.png)
...
![3.5 PEFT 参数高效微调-image-20.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644337178_3.5_PEFT_参数高效微调-image-20.png)
...
![3.5 PEFT 参数高效微调-image-14.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782694492337_3.5_PEFT_参数高效微调-image-14.png)
...
![3.5 PEFT 参数高效微调-image-16.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644334508_3.5_PEFT_参数高效微调-image-16.png)
...
![3.5 PEFT 参数高效微调-image-11.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644323779_3.5_PEFT_参数高效微调-image-11.png)
![3.5 PEFT 参数高效微调-image-17.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644336199_3.5_PEFT_参数高效微调-image-17.png)
...
![3.5 PEFT 参数高效微调-image-13.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644329193_3.5_PEFT_参数高效微调-image-13.png)
...
![3.5 PEFT 参数高效微调-image-18.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644333843_3.5_PEFT_参数高效微调-image-18.png)
![3.5 PEFT 参数高效微调-image-7.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644343317_3.5_PEFT_参数高效微调-image-7.png)
...
* **LoRA的实现：** LoRA旨在 **使用低秩矩阵来编码参数增量 $\Delta\phi$，在训练过程中，低秩的适应矩阵仅仅放大了对下游任务有用的特征，而不是预训练模型中的主要特征**
  ...
  * **Low Rank 低秩：** 根据内在维度的启发，LoRA认为参数更新过程中也存在一个内在秩，对于预训练权重矩阵可以用一个低秩分解来表示参数更新：
  ![3.5 PEFT 参数高效微调-image-12.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644331912_3.5_PEFT_参数高效微调-image-12.png)
  ...
  * **LoRA应该作用在哪些参数矩阵？**：
    ![3.5 PEFT 参数高效微调-image-10.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644329834_3.5_PEFT_参数高效微调-image-10.png)
    * 将所有微调参数都放到attention的某一个参数矩阵的效果并不好，将可微调参数平均分配到𝑊𝑞和𝑊v的效果最好
    * 即使是秩仅取4也能在Δ𝑊中获得足够的信息
  * **LoRA的最优秩r是多少？：**
    ![3.5 PEFT 参数高效微调-image-8.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644352220_3.5_PEFT_参数高效微调-image-8.png)
...
![3.5 PEFT 参数高效微调-image-4.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782694505652_3.5_PEFT_参数高效微调-image-4.png)
...
![3.5 PEFT 参数高效微调-image-5.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644343671_3.5_PEFT_参数高效微调-image-5.png)
...
![3.5 PEFT 参数高效微调-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644322436_3.5_PEFT_参数高效微调-image-1.png)
...
![3.5 PEFT 参数高效微调-image-9.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782694510336_3.5_PEFT_参数高效微调-image-9.png)

## LoRA-FA

> 在LoRA的基础上，冻结矩阵A，矩阵B不是添加新的向量，而是在用零初始化之后进行训练，减少了一半的训练参数
![3.5 PEFT 参数高效微调-image-6.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644343633_3.5_PEFT_参数高效微调-image-6.png)

## AdaLoRA

> LoRA每个Adapter的秩都是一样的，**AdaLoRA对于不同层、类型参数根据下游任务动态分配秩，基于SVD的形式参数化增量更新，这种基于SVD的参数化形式可以在规避SVD复杂的计算的同时高效裁剪不重要的奇异值，从而降低计算量**
![3.5 PEFT 参数高效微调-image-3.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644336168_3.5_PEFT_参数高效微调-image-3.png)
...
![3.5 PEFT 参数高效微调-image-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644340733_3.5_PEFT_参数高效微调-image-2.png)
