...
![](<../images/3.5 PEFT 参数高效微调-image.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-19.png>)
![](<../images/3.5 PEFT 参数高效微调-image-15.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-20.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-14.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-16.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-11.png>)
![](<../images/3.5 PEFT 参数高效微调-image-17.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-13.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-18.png>)
![](<../images/3.5 PEFT 参数高效微调-image-7.png>)
...
* **LoRA的实现：** LoRA旨在 **使用低秩矩阵来编码参数增量 $\Delta\phi$，在训练过程中，低秩的适应矩阵仅仅放大了对下游任务有用的特征，而不是预训练模型中的主要特征**
  ...
  * **Low Rank 低秩：** 根据内在维度的启发，LoRA认为参数更新过程中也存在一个内在秩，对于预训练权重矩阵可以用一个低秩分解来表示参数更新：
  ![](<../images/3.5 PEFT 参数高效微调-image-12.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-4.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-5.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-1.png>)
...
![](<../images/3.5 PEFT 参数高效微调-image-2.png>)
