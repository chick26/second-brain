...
* **整体流程**
![](<../images/3.1 SFT 监督微调-image-1.png>)
...
![](<../images/3.1 SFT 监督微调-image-2.png>)
...
![](<../images/3.1 SFT 监督微调-image-9.png>)
...
![](<../images/3.1 SFT 监督微调-image-6.png>)
![](<../images/3.1 SFT 监督微调-image-8.png>)
![](<../images/3.1 SFT 监督微调-image-4.png>)
...
![](<../images/3.1 SFT 监督微调-image-7.png>)
...
![](<../images/3.1 SFT 监督微调-image-5.png>)
...
![](<../images/3.1 SFT 监督微调-image-3.png>)
...
1. **多轮拆分样本：** 假设我们有一个对话，其中 user 和 bot 交互了 3 轮，我们可以根据这个对话构建三个样本：
   ![](<../images/3.1 SFT 监督微调-diagram.png>)
...
2. **多轮合并加速计算：** 如果将三轮三个样本合并成一个样本，可以尝试这种构造形式。因为存在 causal attention mask，所以每个 token 只能看到前面的 token，计算上和之前是等价的
   ![](<../images/3.1 SFT 监督微调-diagram-1.png>)
...
3. **Packing+加速计算：** 假设我们有两个对话，第一个是单轮对话，第二个是三轮对话。
   ![](<../images/3.1 SFT 监督微调-diagram-2.png>)
   正确的 loss:
