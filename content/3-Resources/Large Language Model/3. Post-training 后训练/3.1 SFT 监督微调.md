...
![3.1 SFT 监督微调-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644236710_3.1_SFT_监督微调-image.png)
...
* **整体流程**
![3.1 SFT 监督微调-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644219100_3.1_SFT_监督微调-image-1.png)
...
![3.1 SFT 监督微调-image-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644225387_3.1_SFT_监督微调-image-2.png)
...
![3.1 SFT 监督微调-image-9.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644236749_3.1_SFT_监督微调-image-9.png)
...
![3.1 SFT 监督微调-image-6.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644235267_3.1_SFT_监督微调-image-6.png)
![3.1 SFT 监督微调-image-8.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644234509_3.1_SFT_监督微调-image-8.png)
![3.1 SFT 监督微调-image-4.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644231918_3.1_SFT_监督微调-image-4.png)
...
![3.1 SFT 监督微调-image-7.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644234233_3.1_SFT_监督微调-image-7.png)
...
![3.1 SFT 监督微调-image-5.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644233094_3.1_SFT_监督微调-image-5.png)
...
![3.1 SFT 监督微调-image-3.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644226171_3.1_SFT_监督微调-image-3.png)
...
1. **多轮拆分样本：** 假设我们有一个对话，其中 user 和 bot 交互了 3 轮，我们可以根据这个对话构建三个样本：
   ![3.1 SFT 监督微调-diagram.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644227873_3.1_SFT_监督微调-diagram.png)
...
2. **多轮合并加速计算：** 如果将三轮三个样本合并成一个样本，可以尝试这种构造形式。因为存在 causal attention mask，所以每个 token 只能看到前面的 token，计算上和之前是等价的
   ![3.1 SFT 监督微调-diagram-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644218654_3.1_SFT_监督微调-diagram-1.png)
...
3. **Packing+加速计算：** 假设我们有两个对话，第一个是单轮对话，第二个是三轮对话。
   ![3.1 SFT 监督微调-diagram-2.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782644222888_3.1_SFT_监督微调-diagram-2.png)
   正确的 loss:
