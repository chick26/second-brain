...
![5.6 推理耗时及优化-image.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782695444280_5.6_推理耗时及优化-image.png)

**第二种形式**，Prompt Cache，属于相对高级的用法，是对整个输入Prompt对应的Key和Value值进行Caching操作，不局限于shared prefix

![5.6 推理耗时及优化-image-1.png](https://2479e837.cloudflare-imgbed-2q4.pages.dev/file/1782695434110_5.6_推理耗时及优化-image-1.png)
